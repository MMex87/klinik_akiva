...
if (isset($_POST['btHapus'])) {
    updateDiagnosaStatusObat($_POST['id_pendaftaran']);
    hapus_diagnosa_obat($_POST['id_pendaftaran']);
}

// tmpilan
$pasien = query("SELECT * FROM pasien INNER jOIN pendaftaran on pasien.id_pasien = pendaftaran.id_pasien WHERE pendaftaran.status = 2");
            ...
            <div class='col-5'>
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="mt-3">
                    <ol class="breadcrumb fw-bold fs-4">
                        ...
                        <li class="breadcrumb-item" style="color: #8471C9 ; font-family: 'Roboto Mono', monospace; font-weight:900;"><a href="diagnosa.php">DIAGNOSA </a></li>
                        <li class="breadcrumb-item active" style="color: #6B59AE ; font-family: 'Roboto Mono', monospace; font-weight:700;">OBAT</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <?php foreach ($pasien as $row) : ?>
                        <form action="pendaftaranTindakanObat.php" method="post">
                            <tr class="p-2 align-baseline" style=" font-family: 'Roboto Mono', monospace; font-weight:390;">
                                ...
                                <td><button type="submit" name="btTindakan" class=" button bg-primary text-light" style="width: 120px; height: 30px; border-radius: 2px; font-family: 'Roboto Mono', monospace; font-weight:450;  border: 2px solid #ffffff;"> TINDAKAN </button></td>
                        </form>
                        <form action="" method="post">
                            <input type="hidden" name="id_pendaftaran" value="<?= $row['id_pendaftaran'] ?>">
                            <td><button type="submit" name="btHapus" style="width: 120px; height: 30px; border-radius: 2px; font-family: 'Roboto Mono', monospace; font-weight:450;  border: 2px solid #ffffff;" class="bg-danger fw-bold text-light">DELETE </button></td>
                            <?php $a++; ?>
                            </tr>
                        </form>
                    <?php endforeach; ?>
