            ...
            <div class='mb-5'>
                <form action="" method="post">
                    ...
                    <table cellspacing='0' cellpadding='5'>
                        ...
                        <tr>
                            ...
                            <td rowspan="10">
                                <div class='float-start ps-3 mb-3'>
                                    <label for='nama_obat' style="font-family: 'Roboto Mono', monospace; font-weight:450;" class="mb-1">Nama Obat</label><br>
                                    <input type='text' name='nama_obat' id='nama_obat' class="mb-3" style="width: 200px; padding-bottom:3px; font-family: 'Roboto Mono', monospace; font-weight:400;">

                                    <label for='jumlah' class="mb-1" style="font-family: 'Roboto Mono', monospace; font-weight:450; text-align:center;">Jumlah</label><br>
                                    <input type='text' name='jumlah' class="mb-3" id='jumlah' style="width: 200px; padding-bottom:3px; font-family: 'Roboto Mono', monospace; font-weight:400; ">

                                    <label for='pemakaian' class="mb-1" style="font-family: 'Roboto Mono', monospace; font-weight:450; text-align:center;">Pemakaian</label><br>
                                    <input type='text' name='pemakaian' class="mb-3" id='pemakaian' style="width: 200px; padding-bottom:3px; font-family: 'Roboto Mono', monospace; font-weight:400;" placeholder=".. x ..">

                                    <label for='satuan' class="mb-1" style="font-family: 'Roboto Mono', monospace; font-weight:450; text-align:center;">Satuan</label><br>
                                    <select name='satuan' class="mb-3" id='aturan' style="width: 200px; padding-bottom:3px; font-family: 'Roboto Mono', monospace; font-weight:400;">
                                    ...
                                    <label for='aturan' class="mb-1" style="font-family: 'Roboto Mono', monospace; font-weight:450; text-align:center;">Aturan</label><br>
                                    <select name='aturan' id='aturan' style="width: 200px; padding-bottom:3px; font-family: 'Roboto Mono', monospace; font-weight:400;">
                                        <option value="Sesudah">Sesudah</option>
                                        <option value="Sebelum">Sebelum</option>
                                        <option value="Pada Saat">Pada Saat</option>
                                    </select>
                                </div>
                            </td>
                        </tr>
                    ...
                    <!-- buuton -->
                    <button type="submit" name="btTambah" class="button bg-primary text-light" style="width: 120px; height: 30px; border-radius: 2px; font-family: 'Roboto Mono', monospace; font-weight:450;  border: 2px solid #ffff; float:right; margin-right:110px; margin-top:7px"> ADD </button>
                </form>
                        ...
                        <tr>
                            ...
                            <td class="tdp">
                                <form action="" method="post">
                                    ...
                                    <input type="hidden" name="lain" id="lain" style="width: 270px;" value="<?= $_POST['lain'] ?>" require>
                                    <input type="hidden" name="O" id="O" style="width: 270px;" value="<?= $kumpulanData ?>" require>
                                    <button type="submit" name="btHapus" style=" width: 120px; height: 30px; margin-left: 110px; border-radius: 2px; font-family: 'Roboto Mono', monospace; font-weight:450;  border: 2px solid #ffff;" class="bg-danger fw-bold text-light">DELETE</button>
                                </form>
                            </td>
                        </tr>
                        <?php $i++;  ?>
                ...
                <div class='float-end mt-2 mb-5' style="margin-right: 90px;">
                    <div class='float-end me-3'>
                        <form action="" method="post">
                            <input type="hidden" name="id_pendaftaran" value="<?= $id_pendaftaran ?>">
                            <button type="submit" name="btSave" class="ms-2 bg-primary fw-bold text-light" style="width: 120px; height: 30px; border-radius: 2px; font-family: 'Roboto Mono', monospace; font-weight:450;  border: 2px solid #ffff;"> SAVE
                    </div></button>
                    </form>
                </div>
